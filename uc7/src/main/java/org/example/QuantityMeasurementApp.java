...
public class QuantityMeasurementApp {
    ...
    public QuantityMeasurementApp add(QuantityMeasurementApp length, LengthUnit target){

        if(length == null) throw new IllegalArgumentException("null input");
        ...
        double sumToTarget = sum / target.conversionFactor;

        return new QuantityMeasurementApp(sumToTarget,target);
    }
    @Override
